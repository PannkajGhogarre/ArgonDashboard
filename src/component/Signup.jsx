      ...
      <div className='bg-[url("./city.jpg")] w-auto h-96 rounded-xl mx-2 my-2 bg-center bg-no-repeat bg-cover'>
                ...
                <div>
                    <div className='flex flex-col h-screen justify-center items-center'>
                            <h2 className='md:text-4xl text-2xl font-semibold py-2 text-white text-center'>Welcome!</h2>
                            <p className='text-base font-norma py-2 text-white text-center'>Use these awesome forms to login or create new account in your <br /> project for free.</p>
                   ...
                   <div className='flex items-center justify-center text-center mt-10 p-2 font-medium text-xl text-gray-400 '>
